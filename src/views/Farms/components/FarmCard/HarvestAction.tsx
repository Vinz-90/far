...
import { useHarvest, useHarvestCompound } from 'hooks/useHarvest'
...
const HarvestAction: React.FC<FarmCardActionsProps> = ({ earnings, pid }) => {
  ...
  const { onRewardCompound } = useHarvestCompound(pid)
        ...
        {pid === 12 ? (
          <Button
            ...
            onClick={async () => {
              setPendingTx(true)
              if (pid === rewardPid) {
                await onStakeCompound(rawEarningsBalance.toString())
              } else {
